...
columnsInTable = {{'subSel_rewardCombo_selInd', 'epochSel_categories_any_selInd', {'subSel_saccadesNonStim_selInd' 'subSel_pre_saccadesNonStim_selInd'}} ...
  ...
  {'subSel_stimOnset_selInd', 'subSel_pre_saccadesNonStim_selInd'}...
};
...
figTitleString = {'Joint Selectivity Array A (NonStim)', 'Joint Selectivity Array A', ...
                  ...
                  'Joint Selectivity E Array (Cat + HT)', 'Joint Selectivity E Array (stimOnsetPreSacc)'};
...
for ii = 1%1:length(figTitleString)
