...
columnsOfInterest = {{'saccDir_fixOnset_selInd', 'saccDir_stimOnset_selInd', 'saccDir_stim_selInd', 'saccDir_all_selInd'}, ...
  {'subSel_saccades_selInd', 'subSel_pre_saccades_selInd'}, {'subSel_pre_saccades_selInd', 'saccDir_all_selInd'},...
  {'subSel_saccadesNonStim_selInd', 'subSel_pre_saccadesNonStim_selInd'}};
