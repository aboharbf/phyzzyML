...
figureTitles = {'%s direction selective activity during task events during %s', '%s activity selective for non-Stimulus Events during %s'};
columnsOfInterest = {{'saccDir_fixOnset_selInd', 'saccDir_stimOnset_selInd', 'saccDir_stim_selInd', 'saccDir_all_selInd'}, {'subSel_saccades_selInd', 'subSel_pre-saccades_selInd'}};
eventNames = {{'Fixation Dot Onset', 'Stimulus Onset', 'Stimulus', 'All'}, {'Pre Saccade', 'Post Saccade'}};
