...
binParams = decoding_results.DS_PARAMETERS.binned_site_info.binning_parameters;
end_time = binParams.end_time - 2;
...
if size(correctLineMean,1) == size(correctLineMean, 2)
  % This means
  correctLineMean = correctLineMean(logical(eye(length(correctLineMean))));
end
