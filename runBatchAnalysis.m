...
save_file_name = fullfile(params.rasterDir, 'results');
...
specific_binned_labels_names = 'social'; % Which label in the binned data would you like to classify?
num_cv_splits = 20; % use 20 cross-validation splits (which means that 19 examples of each object are used for training and 1 example of each object is used for testing)
